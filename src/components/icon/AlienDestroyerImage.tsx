...
interface AlienDestroyerImageProps extends React.SVGProps<SVGSVGElement> {
    flipped?: boolean;
}

export const AlienDestroyerImage: React.FC<AlienDestroyerImageProps> = ({ flipped = false, style, ...props }) => (
    <svg
        width={240}
        height={80}
        viewBox="0 0 120 40"
