...
interface AlienFighterImageProps extends React.SVGProps<SVGSVGElement> {
    flipped?: boolean;
}

export const AlienFighterImage: React.FC<AlienFighterImageProps> = ({ flipped = false, style, ...props }) => (
    <svg
        width={160}
        height={80}
        viewBox="0 0 80 40"
