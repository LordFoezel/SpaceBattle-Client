...
interface AlienCargoImageProps extends React.SVGProps<SVGSVGElement> {
    flipped?: boolean;
}

export const AlienCargoImage: React.FC<AlienCargoImageProps> = ({ flipped = false, style, ...props }) => (
    <svg
        width={320}
        height={80}
        viewBox="0 0 160 40"
